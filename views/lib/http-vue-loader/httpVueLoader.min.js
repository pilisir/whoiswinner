...
return Promise.resolve(this.module.exports)}};function ScriptContext(component,elt){this.component=component;this.elt=elt;this.module={exports:{}}}
...
return p.then(function(content){if(eltCx!==null&&eltCx.elt.hasAttribute('lang')){var lang=eltCx.elt.getAttribute('lang');eltCx.elt.removeAttribute('lang');return httpVueLoader.langProcessor[lang.toLowerCase()](content===null?eltCx.getContent():content)}
return content}).then(function(content){if(content!==null)
...
resolve(xhr.responseText);else reject(xhr.status)}};xhr.send(null)})};httpVueLoader.langProcessor={html:identity,js:identity,css:identity};function httpVueLoader(url,name){var comp=parseComponentURL(url);return httpVueLoader.load(comp.url,name)}
